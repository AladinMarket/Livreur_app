...
class Methods {
  ...
  Methods.fromJson(Map<String, dynamic> json) {
    ...
    deliveryManId = json['deliveryManId'] != null ? int.parse(json['deliveryManId'].toString()) : null;
    ...
    isDefault = json['is_default'] != null ? int.parse(json['is_default'].toString()) : null;
