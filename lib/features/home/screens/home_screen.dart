          ...
          GetBuilder<ProfileController>(builder: (profileController) {
            return GetBuilder<OrderController>(builder: (orderController) {
              return (profileController.profileModel != null && orderController.currentOrderList != null) ? FlutterSwitch(
                width: 90, height: 30, valueFontSize: Dimensions.fontSizeExtraSmall, showOnOff: true,
            ...
            return Column(children: [
              ...
              Row(children: [
                ...
                Expanded(child: CountCardWidget(
                  title: 'todays_orders'.tr, backgroundColor: Colors.blueGrey, height: 100,
                  value: profileController.profileModel?.todaysOrderCount.toString(),
                )),
                const SizedBox(width: Dimensions.paddingSizeSmall),

                Expanded(child: CountCardWidget(
                  title: 'this_week_orders'.tr, backgroundColor: Colors.deepOrangeAccent, height: 100,
              ...
              CountCardWidget(
                title: 'total_orders'.tr, backgroundColor: Colors.green, height: 100,
