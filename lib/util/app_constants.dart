...
class AppConstants {
  static const String appName = 'Aladin Livreur';
  static const double appVersion = 2.5;

  static const String baseUrl = 'https://portail.aladinmarket-bf.com';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.francais, languageName: 'Francais', countryCode: 'FR', languageCode: 'fr'),
